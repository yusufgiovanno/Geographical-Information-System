                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        Form Master Data Management : Master User
                                    </h3>
                                    ...
                                    if ($e == 'nonaktif')
                                            {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        $.ajax({
                                                            url: 'hapus/hapus-user.php?id=$gidmode',
                                                            action: 'post',
                                                            data: {
                                                                id: id
                                                            },
                                                    ...
                                                    window.location.href = 'transaksi-camp.php';
                                                })    
                                                </script>";
                                            }
                                    if ($e == 'aktivasi')
                                        ...
                                        Swal.fire({
                                        title: 'Horeeee',
                                        text: 'User Berhasil Diaktivasi Selamat Horeee !',
                                        icon: 'success'
                                        }).then((result) => {
                                        if (result.isConfirmed) {
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    if ($_SESSION['hakakses'] == 1){
                                                        $query = mysql_query("SELECT * FROM master_aksesuser ORDER BY aksesuser_id");
                                                    } else if ($_SESSION['hakakses'] == 2){
                                                        $query = mysql_query("SELECT * FROM master_aksesuser WHERE aksesuser_hakakses = '3' ORDER BY aksesuser_id");
                                                    }
                                                    
                                                    //Tampilkan Data Selama Masih Ada
                                                    while($data = mysql_fetch_array($query)) {
                                                        if($data['aksesuser_status']==1)
                                                        {
                                                            $status = "Aktif";
                                                            $status_ = "1";
                                                        }
                                                        if($data['aksesuser_status']==0)
                                                        {
                                                            $status = "Tidak Aktif";
                                                            $status_ = "0";
                                                        }
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php echo $data['aksesuser_login'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['aksesuser_password'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $status ?>
                                                    </td>
                                                    <td>
                                                        <a data-toggle="tooltip" title="Ubah Data"
                                                            class="btn btn-info btn-sm"
                                                            href="<?=$url?>?e=Edit&idmode=<?=$data['aksesuser_id']?>">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a data-toggle="tooltip" title="Aktivasi Data"
                                                            class="btn btn-info btn-sm"
                                                            href="<?=$url?>?e=aktivasi&idmode=<?=$data['aksesuser_id']?>">
                                                            <i class="fa fa-check"></i>
                                                        </a>
                                                        <a data-toggle="tooltip" title="Hapus Data"
                                                            class="btn btn-danger btn-sm"
                                                            href="<?=$url?>?e=nonaktif&idmode=<?=$data['aksesuser_id']?>">
