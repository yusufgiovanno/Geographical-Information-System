			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Username is required: ex@abc.xyz">
                        ...
                        maxlength="20" id="username" name="username" autocomplete="off" />
...
opendb();
$username=$_POST['username_gkim'];
$password=$_POST['password_gikm'];

if (!isset ($_SESSION['username_gkim'])) {
	header ("location : conf_login.php");
}
?>
</html>