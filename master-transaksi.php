<?php
    ...
    $url1="transaksi-camp.php";
    $url2="transaksi-sewa.php";
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        Form Master Data Management : Master Transaksi
                                    </h3>
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function(data){
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    if (result.isConfirmed) {     
                                                                        window.location.href = 'master-transaksi.php';
                                                                    }
                                                                  })  
                                                            }
                                                        })
                                ...
                                <form class="form" action="" method="post" name="frmmastertransaksi">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <span class="form-text text-muted">Pilih Tipe Master</span>
                                        </div>
                                    </div>
                                </form>
                                <!--END FORM-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable"
                                            ...
                                            <tbody>
                                                <?php
                                                    $n=1;
                                                    $query = mysql_query("  SELECT * FROM master_transaksi WHERE transaksi_status = 1 ");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" title="Ubah Data"
                                                            ...
                                                            href="<?=$data['id_kategori'] == 1? $url1 : $url2;?>?e=Edit&idmode=<?=$data['transaksi_id']?>">
