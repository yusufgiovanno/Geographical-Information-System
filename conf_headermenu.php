...
opendb();
session_start();
$uidmode = $_SESSION['idpengguna'];
$query_edit= "SELECT * FROM master_aksesuser WHERE aksesuser_id = '$uidmode'";
            ...
            <div class="topbar">
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                        ...
                        <span
                            class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?=$data_queryedit['aksesuser_login'];?></span>
