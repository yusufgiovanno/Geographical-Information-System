                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                <div class="card-header" hidden>
                                    ...
                                    <div <?php echo 'style="display:none"'?>class="card-toolbar">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable"
                                            ...
                                            <tbody>
                                                <?php
                                                    $n=1;
                                                    $query = mysql_query("  SELECT * FROM `master_transaksi` WHERE transaksi_status = 1 AND usercreated = '$pengguna_nama'");
