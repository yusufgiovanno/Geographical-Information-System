                        ...
                        <div class="col-lg-6 col-xxl-4">
                            ...
                            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                ...
                                <div class="card-header border-0 bg-danger py-5">
                                    <h3 class="card-title font-weight-bolder text-white">Mastering</h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body p-0 position-relative overflow-hidden">
                                    <!--begin::Chart-->
                                    <div id="kt_mixed_widget_1_charta" class="card-rounded-bottom bg-danger"
                                        style="height: 200px">
                                    ...
                                    <div class="card-spacer mt-n25">
                                        <!--begin::Row-->
                                        <div class="row m-0">
                                            <div class="col px-6 py-8 rounded-xl mr-5 mb-7"
                                                style="background-color:#fff875">
                                                <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <a href="master-kelurahan.php"
                                                    class="text-warning font-weight-bold font-size-h7">
                                                    Master Kelurahan
                                                </a>
                                            </div>
                                            <div class="col bg-light-warning px-6 py-8 rounded-xl mr-5 mb-7">
                                                <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Media/Equalizer.svg--><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                                <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <a href="master-user"
                                                    class="text-primary font-weight-bold font-size-h7 mt-2">
                                                    Master Users
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row m-0">
                                            <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                                <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <a href="master-kecamatan.php"
                                            ...
                                            <div class="col bg-light-success px-6 py-8 rounded-xl">
                                                <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <a href="master-transaksi.php"
